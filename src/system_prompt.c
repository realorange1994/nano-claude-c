...
"## Using your tools\n"
"\n"
"IMPORTANT: You must use the EXACT tool names as defined above. Common mistakes to avoid:\n"
"- Use \"Shell\", NOT \"Bash\", \"Command\", or \"Exec\"\n"
"- Use \"Read\", NOT \"Cat\" or \"FileRead\"\n"
"- Use \"Write\", NOT \"CreateFile\" or \"WriteFile\"\n"
"- Use \"Edit\", NOT \"EditFile\" or \"Replace\"\n"
"- Use \"Grep\", NOT \"Search\" or \"Find\"\n"
"- Use \"Glob\", NOT \"FindFiles\" or \"ListFiles\"\n"
"- Use \"Calc\", NOT \"Calculate\" or \"Math\"\n"
"\n"
...
char *system_prompt_build(ToolRegistry *tools, const char *model,
    ...
    size_t total = static_need + dynamic_need + 64;
