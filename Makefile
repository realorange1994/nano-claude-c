...
SRCS = src/main.c src/http.c src/buffer.c src/config.c src/history.c src/provider.c src/calc.c src/glob.c src/rgrep.c src/tool.c src/tool_impl.c src/jsonrpc.c src/repl.c src/system_prompt.c src/retry.c deps/cJSON/cJSON.c
OBJS = $(SRCS:.c=.o)
